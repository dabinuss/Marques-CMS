...
<head>
  ...
  <title><?php echo htmlspecialchars($title ?? '403 - Zugriff verweigert'); ?> - <?php echo htmlspecialchars($system_settings['site_name'] ?? 'Super Blog'); ?></title>
...
<body>
  <div class="super-blog-error-container">
    ...
    <p class="super-blog-error-message"><?php echo htmlspecialchars($content ?? 'Du hast keine Berechtigung, auf diese Seite zuzugreifen.'); ?></p>
