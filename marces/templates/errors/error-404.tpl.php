...
<head>
    ...
    <title><?php echo htmlspecialchars($title ?? '404 - Seite nicht gefunden'); ?> - <?php echo htmlspecialchars($system_settings['site_name'] ?? 'marces CMS'); ?></title>
...
<body>
    <div class="error-container">
        ...
        <p class="error-message">
            <?php echo htmlspecialchars($content ?? 'Die von Ihnen gesuchte Seite existiert nicht oder wurde verschoben.'); ?>
        </p>
