...
<head>
    ...
    <title>Versionen: <?php echo htmlspecialchars($page['title']); ?> - Admin-Panel - <?php echo htmlspecialchars($system_config['site_name'] ?? 'marces CMS'); ?></title>
