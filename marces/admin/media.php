...
$mediaManager = new \Marces\Core\MediaManager();
...
<head>
    ...
    <title>Medienverwaltung - Admin-Panel - <?php echo htmlspecialchars($system_config['site_name'] ?? 'marces CMS'); ?></title>
            ...
            <?php else: ?>
                <div class="media-grid">
                    <?php foreach ($media as $item): ?>
                        <div class="media-item" data-url="<?php echo marces_site_url($item['cache_bust_url']); ?>" data-filename="<?php echo htmlspecialchars($item['filename']); ?>">
