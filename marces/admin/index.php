...
<head>
    ...
    <title><?php echo htmlspecialchars($page_title); ?> - Admin-Panel - <?php echo htmlspecialchars($system_config['site_name'] ?? 'marces CMS'); ?></title>
        ...
        <main class="admin-content">
            ...
            <?php if ($page === 'dashboard'): ?>
                ...
                <div class="admin-stat-card">
                    ...
                    <p><strong>marces CMS-Version:</strong> <?php echo $stats['marces_version']; ?></p>
                </div>
