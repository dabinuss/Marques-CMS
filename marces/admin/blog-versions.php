...
$versionManager = new \Marces\Core\VersionManager();
...
<head>
    ...
    <title>Versionen: <?php echo htmlspecialchars($post['title']); ?> - Admin-Panel - <?php echo htmlspecialchars($system_config['site_name'] ?? 'marces CMS'); ?></title>
    ...
    <div class="admin-layout">
        ...
        <main class="admin-content">
            <div class="admin-topbar">
                <h2 class="admin-page-title">Versionen: <?php echo htmlspecialchars($post['title']); ?></h2>
                
                <div class="admin-actions">
                    <a href="blog-edit.php?id=<?php echo htmlspecialchars($post_id); ?>" class="admin-button">
            ...
            <?php if ($show_version && $version_metadata): ?>
                <div class="admin-form">
                    ...
                    <div class="version-actions">
                        ...
                        <a href="blog-versions.php?id=<?php echo htmlspecialchars($post_id); ?>" class="admin-button">
                                ...
                                <?php foreach ($versions as $version): ?>
                                    <tr>
                                        ...
                                        <td class="admin-table-actions">
                                            <a href="blog-versions.php?id=<?php echo htmlspecialchars($post_id); ?>&version=<?php echo htmlspecialchars($version['version_id']); ?>" class="admin-table-action" title="Anzeigen">
